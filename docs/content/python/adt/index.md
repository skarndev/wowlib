...
each a 16 × 16 grid of terrain cells (**MCNK**) with heights, normals, texture
...
`_lod` satellites, *distributing* the same chunks (and each cell's MCNK
...
- **[Terrain cells](cells.md)** — the `MapChunk` cell class: heights, normals,
