...
namespace wowlib::formats::wdl {
  ...
  inline constexpr std::uint32_t WdlVersion18 = 18;
  ...
  inline constexpr std::array WdlPivots{builds::TBC, builds::Legion, builds::BfA, builds::SL, builds::TWW};
}
