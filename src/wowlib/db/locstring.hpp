...
namespace wowlib::db {
  ...
  struct [[
    ...
    [[=welder::mark::no_reassign,
      =welder::doc(
        "The language slot values in client column order (0 enUS, 1 koKR, "
    ...
    [[=welder::doc(
      "The trailing locale flags field; a bitmask the client never "
    ...
    [[nodiscard]]
    [[=welder::doc(
        "The string stored for a locale; empty when the locale has no "
